<template>
  ...
  >
    <!-- 亮色模式图标 -->
    <Sun v-if="theme === 'light'" class="w-4 h-4 text-graphite" />
    <!-- 暗色模式图标 -->
    <Moon v-else-if="theme === 'dark'" class="w-4 h-4 text-stone-400" />
    <!-- 系统模式图标 -->
    <Monitor v-else class="w-4 h-4 text-graphite dark:text-stone-400" />
