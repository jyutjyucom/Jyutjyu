  ...
  <div class="flex flex-wrap items-center gap-2 sm:gap-3" data-search-interactive>
    ...
    <div class="relative">
      ...
      >
        ...
        <svg
          class="w-4 h-4"
          :class="showDictDropdown ? 'rotate-180' : ''"
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
        >
      ...
      >
        <button
          ...
          :class="
            !selectedDict
              ? 'text-kapok bg-kapok/10 dark:bg-kapok/20'
              : 'text-graphite dark:text-stone-100'
          "
          @click="$emit('select-dict', null)"
        >
    ...
    <div class="relative">
      ...
      >
        <span>{{
          selectedDialect
            ? getDialectLabel(selectedDialect)
            : t("common.allDialects")
        }}</span>
        <svg
          class="w-4 h-4"
          :class="showDialectDropdown ? 'rotate-180' : ''"
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
        >
      ...
      >
        <button
          ...
          :class="
            !selectedDialect
              ? 'text-archive-green bg-archive-green/10 dark:bg-archive-green/20'
              : 'text-graphite dark:text-stone-100'
          "
          @click="$emit('select-dialect', null)"
        >
          {{ t("common.allDialects") }}
        </button>
        <button
    ...
    <div class="relative">
      ...
      >
        <button
          ...
          :class="
            !selectedType
              ? 'text-muted-gold bg-muted-gold/10 dark:bg-muted-gold/20'
              : 'text-graphite dark:text-stone-100'
          "
