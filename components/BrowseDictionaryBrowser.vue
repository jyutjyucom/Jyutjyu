    ...
    <div class="lg:grid lg:grid-cols-12 lg:gap-6">
      ...
      <section class="lg:col-span-8 xl:col-span-9">
        ...
        <div class="bg-surface-low dark:bg-stone-900 px-4 py-3">
          ...
          >
            <p class="text-graphite dark:text-stone-400 text-base">
              <span class="font-medium text-ink dark:text-parchment">{{
                activeScopeLabel
              }}</span>
              <span class="mx-2 text-graphite/30 dark:text-stone-300">·</span>
              {{
                t("browse.entries", {
        ...
        <div class="my-4 min-h-[18rem]">
          ...
          >
            <div class="text-center text-graphite/60 dark:text-stone-200">
              <div
...
const handleSortChange = (event: Event) => {
  ...
  const safeSort = sortOptions.includes(rawSort as BrowseSort)
    ...
    : DEFAULT_SORT_BY;
  void navigateTo(
    buildScopePath(activeScopeId.value, 1, props.browseData.pageSize, safeSort),
  );
};
