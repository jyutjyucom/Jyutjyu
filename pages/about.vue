  ...
  <div class="min-h-screen bg-parchment dark:bg-stone-950">
    <div class="max-w-4xl mx-auto px-6 md:px-8 py-16 font-cjk-ui">
      ...
      <div class="mb-12">
        ...
        <h1
          class="text-4xl font-headline font-bold text-ink dark:text-parchment mb-4"
        >
          {{ t("about.title") }}
        </h1>
        <p class="text-xl text-graphite dark:text-stone-400">
          {{ t("about.subtitle") }}
        </p>
      </div>
      ...
      <!-- 项目介绍 -->
      <div class="mb-12">
        <div class="bg-surface-low dark:bg-stone-900 p-8">
          <h2
            class="text-2xl font-headline font-semibold mb-4 text-ink dark:text-parchment"
          >
            {{ t("about.missionTitle") }}
          </h2>
          <p class="text-ink/80 dark:text-stone-300 mb-4">
            {{ t("about.missionP1") }}
          </p>
          <p class="text-ink/80 dark:text-stone-300 mb-4">
            {{ t("about.missionP2") }}
          ...
          <div class="flex flex-wrap gap-4 mt-6">
            <a
              ...
              target="_blank"
              class="inline-flex items-center gap-2 px-4 py-2 bg-ink dark:bg-stone-700 text-white hover:bg-ink/80 dark:hover:bg-stone-600 transition-colors whitespace-nowrap flex-shrink-0"
            >
      ...
      <div class="mb-12">
        <div class="bg-surface-low dark:bg-stone-900 p-8">
          <h2
            class="text-2xl font-headline font-semibold mb-6 flex items-center gap-2 text-ink dark:text-parchment"
          >
            <svg
              class="w-6 h-6 text-archive-green"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
          ...
          <p class="text-ink/80 dark:text-stone-300 mb-6">
            {{ t("about.licenseIntro") }}
          </p>

          <!-- 出版词典 -->
          <div
            class="mb-8 border-l-4 border-muted-gold pl-6 py-2 bg-muted-gold/5 dark:bg-muted-gold/10"
          >
            <h3 class="text-xl font-semibold mb-3 text-ink dark:text-parchment">
            ...
            <div class="bg-white dark:bg-stone-800 p-4 mb-4">
              <h4 class="font-semibold text-ink dark:text-parchment mb-2">
              ...
              <p class="text-sm text-ink/80 dark:text-stone-300 mb-3">
                ...
                <a
                  href="https://github.com/jyutjyucom/jyutjyu/issues"
                  class="text-kapok hover:text-kapok/80 hover:underline"
                  target="_blank"
                  >GitHub Issue</a
                >
              </p>
              ...
              <ul
                class="text-sm text-ink/80 dark:text-stone-300 list-disc list-inside space-y-1 mb-3"
              >
              ...
              <div
                class="bg-kapok/5 dark:bg-kapok/10 border-l-2 border-kapok/40 p-3 mt-4"
              >
                <p class="text-sm text-ink/80 dark:text-stone-300">
          ...
          <!-- 社区协作词典 -->
          <div
            class="mb-8 border-l-4 border-archive-green pl-6 py-2 bg-archive-green/5 dark:bg-archive-green/10"
          >
            <h3 class="text-xl font-semibold mb-3 text-ink dark:text-parchment">
            ...
            <div
              class="bg-muted-gold/5 dark:bg-muted-gold/10 border-l-2 border-muted-gold/40 p-4 mb-4"
            >
              <p class="text-sm text-ink/80 dark:text-stone-300">
            ...
            <div class="bg-white dark:bg-stone-800 p-4 mb-4">
              ...
              <h5
                class="font-semibold text-ink dark:text-parchment text-sm mb-2"
              >
              ...
              <p class="text-sm text-ink/80 dark:text-stone-300 mb-3">
                <a
                  ...
                  class="text-kapok hover:text-kapok/80 hover:underline font-medium"
                  target="_blank"
                  >Non-Commercial Open Data License 1.0</a
                >{{ t("about.community.wordsLicenseNote") }}
              </p>
            ...
            <div class="bg-white dark:bg-stone-800 p-4 mb-4">
              ...
              <p class="text-sm text-ink/80 dark:text-stone-300 mb-3">
                <a
                  ...
                  target="_blank"
                  >CC BY-SA 4.0</a
                >{{ t("about.community.wiktLicenseNote") }}
              </p>
          ...
          <!-- 社区原创词表 -->
          <div
            class="mb-6 border-l-4 border-kapok pl-6 py-2 bg-kapok/5 dark:bg-kapok/10"
          >
            <h3 class="text-xl font-semibold mb-3 text-ink dark:text-parchment">
            ...
            <div class="bg-white dark:bg-stone-800 p-4 mb-4">
              ...
              <div
                class="bg-archive-green/5 dark:bg-archive-green/10 border-l-2 border-archive-green/40 p-3 mt-4"
              >
                <p class="text-sm text-ink/80 dark:text-stone-300">
                  {{ t("about.original.attributionExample") }}
                  <br />
                  <code
                    class="text-xs bg-surface-highest dark:bg-stone-700 px-2 py-1"
                  >
            ...
            <div class="bg-white dark:bg-stone-800 p-4 mb-4">
              ...
              <p class="text-sm text-ink/80 dark:text-stone-300 mb-3">
                <a
                  ...
                  target="_blank"
                  >GPL-3.0</a
                >{{ t("about.original.qzLicenseNote") }}
              </p>
          ...
          <!-- 网络公开词典（协议不明） -->
          <div
            class="mb-6 border-l-4 border-graphite/30 dark:border-stone-600 pl-6 py-2 bg-surface-high/50 dark:bg-stone-800/50"
          >
            <h3 class="text-xl font-semibold mb-3 text-ink dark:text-parchment">
          ...
          <!-- 权利声明 -->
          <div
            class="bg-surface-high dark:bg-stone-800 border border-outline-soft/20 dark:border-stone-700 p-6 mt-6"
          >
            <h3 class="text-lg font-semibold mb-3 text-ink dark:text-parchment">
              {{ t("about.rights.title") }}
            </h3>
            <p class="text-sm text-ink/80 dark:text-stone-300 mb-4">
              {{ t("about.rights.intro") }}
            </p>
            <div class="space-y-2 text-sm text-ink/80 dark:text-stone-300">
              <p>
              ...
              <ul class="list-disc list-inside pl-4 space-y-1">
                ...
                <li>
                  GitHub Discussions:
                  <a
                    href="https://github.com/jyutjyucom/jyutjyu/discussions"
                    class="text-kapok hover:text-kapok/80 hover:underline"
                    target="_blank"
                  >
              ...
              <p class="pt-2 text-graphite dark:text-stone-400">
      ...
      <div class="mb-12">
        <div class="bg-surface-low dark:bg-stone-900 p-8">
          ...
          <div
            class="grid md:grid-cols-2 gap-4 text-sm text-ink/80 dark:text-stone-300"
          >
            <div>
              <h3 class="font-semibold mb-2 text-ink dark:text-parchment">
      ...
      <!-- 贡献指南 -->
      <div>
        <div class="bg-surface-low dark:bg-stone-900 p-8 text-center">
          <h2
            class="text-2xl font-headline font-semibold mb-4 text-ink dark:text-parchment"
          >
          ...
          <div class="flex flex-wrap gap-4 justify-center">
            <a
              ...
              target="_blank"
              class="px-6 py-3 bg-kapok text-white hover:bg-kapok/90 transition-colors font-medium"
            >
            ...
            <a
              ...
              target="_blank"
              class="px-6 py-3 border border-kapok text-kapok hover:bg-kapok/10 transition-colors font-medium"
            >
...
const wiktCountDisplay = computed(() => {
  const data = dictionariesData.value as any;
  if (!data?.dictionaries) return "0";
  const dict = data.dictionaries.find(
    (d: any) => d.id === "wiktionary-cantonese",
  );
  return (dict?.entries_count || 0).toLocaleString();
});
...
useHead(() => ({
  ...
  meta: [
    ...
    {
      property: "og:title",
      content: `${t("about.pageTitle")} | ${t("common.siteName")}`,
    },
