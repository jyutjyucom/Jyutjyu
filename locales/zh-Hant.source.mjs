...
const messagesZhHant = {
  ...
  common: {
    ...
    licenseScannedDisclaimerPrefix: '詞條內容由書籍作者負責。因使用 OCR 批量處理，難免有錯誤，如發現問題可在',
    ...
    footerOcrDisclaimerPrefix: '本站詞條內容是 OCR 自動轉換的，如有錯漏，請多多',
    searchHeader: '搜尋結果',
  ...
  about: {
    ...
    missionTitle: '使命',
    missionP1: '粵語辭叢致力於建立一個先進實用的粵語詞典平台，以現代技術傳承和推廣粵語文化。',
    missionP2: '通過聚合多個來源的粵語詞典，我們為粵語學習者、研究者、愛好者提供一個方便且全面的查詢工具。',
    backHome: '返回首頁',
    licenseSectionTitle: '內容授權說明',
    licenseIntro: '本平台收錄的詞典內容按來源大致分成兩類，每類都有相應的授權和使用限制：',
    published: {
      title: '出版詞典',
      examples: '例如《實用廣州話分類詞典》（麥耘、譚步雲編，廣東人民出版社，1997 年）、《廣州話俗語詞典》（歐陽覺亞、周無忌、饒秉才編，廣東人民出版社，2010 年）等。',
      copyrightTitle: '版權狀態',
      copyright: '這些詞典內容受中華人民共和國著作權法保護，數據來源是網際網路上公開的掃描資源。',
      disclaimerTitle: '內容免責',
      disclaimer: '詞條內容由原書籍作者負責。本平台數據來源於 OCR 批量處理，因技術限制，難免有識別錯誤或格式問題。如果您發現錯誤，歡迎通過 GitHub Issue 提出：',
      ...
      supportOriginal: '我們鼓勵用戶支持正版：如需正式使用這些詞典內容，請購買正版出版物或聯絡出版方獲取授權。'
    },
    community: {
      title: '社群協作詞典',
      intro: '由開放社群協作編寫的詞典，採用開放授權協議。',
      disclaimer: '內容免責：社群協作詞典中的詞條內容，全部由各自社群的編者負責編寫和維護。本網站僅作為內容聚合展示平台，不對詞條內容的準確性、完整性或適用性承擔責任。如對具體詞條內容有疑問，請訪問原詞典網站或聯絡相關編者團隊。',
      licenseTitle: '許可協議',
      allowedTitle: '允許的使用方式',
      conditionsTitle: '使用條件',
      wordsTitle: '粵典 (words.hk) - {count} 詞條',
      wordsDesc: '香港粵語社群詞典，收錄大量日常用語、俚語和現代詞彙，提供粵語和英語雙語釋義。',
      allowed1: '非商業使用、複製、修改、發佈',
      allowed2: '必須保留署名和版權告示',
      commercialTitle: '商業使用',
      commercialDesc: '需要另外獲取授權（收入低於地區中位數 3 倍的小型個人業務可豁免）',
    ...
    original: {
      ...
      qzDesc: '《欽州白話》的詞頭和注音部分，收錄欽州話詞彙和粵拼。由 Lai Joengzit 等愛好者原創整理，2020年發佈。',
    ...
    rights: {
      ...
      contactIntro: '如果您是權利人，並對本平台收錄內容有任何疑問，或希望修改、下架相關內容，可通過以下方式聯絡我們：',
