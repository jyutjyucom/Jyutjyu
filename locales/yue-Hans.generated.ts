...
const messagesYueHans = {
  ...
  "common": {
    ...
    "viewLicense": "睇完整授权说明",
    "licenseLabel": "许可：",
    "licenseCommunityDisclaimer": "词条内容由社群编者负责，本网站唔对内容负责。",
  ...
  "wordPage": {
    ...
    "backToSearchResultsFor": "返去「{query}」搜寻结果",
    "backToSearchResultsForCount": "返去「{query}」搜寻结果（{count} 项）",
    "searchCurrentWord": "搜寻「{word}」",
    "viewCurrentWordResults": "睇「{word}」搜寻结果"
  },
  "dictCard": {
  ...
  "about": {
    "pageTitle": "关于",
    "metaDescription": "了解粤语辞丛项目嘅使命、内容授权政策同技术架构。我哋致力于打造开放、包容、可持续嘅粤语词典聚合平台。",
    "title": "关于粤语辞丛",
    "subtitle": "Open Yue Dictionary Collection Platform - 开源粤语词典聚合平台",
    "missionTitle": "使命",
    "missionP1": "粤语辞丛致力于建立一个先进实用嘅粤语词典平台，用现代技术传承同推广粤语文化。",
    "missionP2": "通过聚合多个来源嘅粤语词典，我哋为粤语学习者、研究者、爱好者提供一个方便又全面嘅查询工具。",
    "backHome": "返回首页",
    ...
    "published": {
      ...
      "copyrightTitle": "版权状态",
      "copyright": "呢啲词典内容受中华人民共和国著作权法保护，数据来源系互联网上公开嘅扫描资源。",
    ...
    "community": {
      "title": "社群协作词典",
      "intro": "由开放社群协作编写嘅词典，采用开放授权协议。",
      "disclaimer": "内容免责：社群协作词典入面嘅词条内容，全部都系由各自社群嘅编者负责编写同维护。本网站只系做内容聚合展示平台，唔对词条内容嘅准确性、完整性或者适用性承担责任。如果对具体词条内容有疑问，请访问原词典网站或者联络相关编者团队。",
      "licenseTitle": "许可协议",
      "allowedTitle": "允许嘅使用方式",
      "conditionsTitle": "使用条件",
      "wordsTitle": "粤典 (words.hk) - {count} 词条",
      "wordsDesc": "香港粤语社群词典，收录大量日常用语、俚语同现代词汇，提供粤语同英语双语释义。",
    ...
    "original": {
      ...
      "qzDesc": "《钦州白话》嘅词头同注音部分，收录钦州话词汇同粤拼。由 Lai Joengzit 等爱好者原创整理，2020年发布。",
    ...
    "rights": {
      ...
      "contactIntro": "如果你系权利人，并且对本平台收录内容有任何疑问，或者希望修改、下架相关内容，可以通过以下方式联络我哋：",
