...
export const DICTIONARY_INFO = {
  ...
  description: {
    'zh-Hans': '现代权威粤语词典，系统收录广州话词汇，包含详细释义、读音、用例等',
    'zh-Hant': '現代權威粵語詞典，系統收錄廣州話詞彙，包含詳細釋義、讀音、用例等',
    'yue-Hans': '现代权威粤语词典，系统收录广州话词汇，包含详细释义、读音、用例等',
    'yue-Hant': '現代權威粵語詞典，系統收錄廣州話詞彙，包含詳細釋義、讀音、用例等'
  },
