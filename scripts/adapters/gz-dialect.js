...
export const DICTIONARY_INFO = {
  ...
  description: {
    "zh-Hans":
      "收录广州话词汇，包含释义、读音、用例等，是研究粤语（广州话）的重要工具书",
    "zh-Hant":
      "收錄廣州話詞彙，包含釋義、讀音、用例等，是研究粵語（廣州話）的重要工具書",
    "yue-Hans":
      "收录广州话词汇，包含释义、读音、用例等，系研究粤语（广州话）嘅重要工具书",
    "yue-Hant":
      "收錄廣州話詞彙，包含釋義、讀音、用例等，係研究粵語（廣州話）嘅重要工具書",
  },
...
function parseWithSubSenses(text, subSenseMatches) {
  ...
  for (let i = 0; i < subSenseMatches.length; i++) {
    ...
    const end =
      i < subSenseMatches.length - 1
        ? subSenseMatches[i + 1].index
        : text.length;
